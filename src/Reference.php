...
class Reference {
  ...
  function inform($parameters, $update = false, $user_id = 0) {
    if (!empty($parameters)) {
      if (isset($parameters["input_option_static_value"]) && !empty($parameters["input_option_static_value"])) {
        if (is_array($parameters["input_option_static_value"])) {
  ...
  function format($data, $return_references = false, $referers = null) {
    if (!empty($data)) {
      ...
      if (isset($data->input_option_static_value) && !empty($data->input_option_static_value)) {
        $data->input_option_static_value = explode(",", $data->input_option_static_value);
      }
